...
def add_args(parser):
    parser.add_argument("--task", type=str, required=True,
                    choices=['summarize', 'concode', 'translate', 'refine', 'defect', 'clone', 'masked']) # Adding our masked task here
    ...
    elif args.task == 'masked':
        args.lang = 'r' # Setting the lang to r since our dataset is in R
    return args
